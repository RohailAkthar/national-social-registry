...
class G2PHouseholdPds:
    program_name: Mapped[str | None] = mapped_column(String, nullable=True, default="PDS_FOOD_SECURITY")

    # PDS Food Security (Ration Card) fields from Mock Excel
...
class G2PRegisterHouseholdPds(G2PRegister, G2PHouseholdPds):
    __tablename__ = "g2p_register_household_pds"

    def get_record_name_fields(self) -> str:
        return f"PDS Ration Card ({self.ration_card_number or 'N/A'})"

    def get_search_text_fields(self) -> str:
        return f"{self.ration_card_number or ''} {self.head_of_household_name or ''} {self.dealer_name or ''}"


class G2PIntakeFormHouseholdPds(G2PIntakeForm, G2PRegister, G2PHouseholdPds):
    __tablename__ = "g2p_intake_form_household_pds"
...
class G2PRegisterHistoryHouseholdPds(G2PRegisterHistory, G2PHouseholdPds):
    __tablename__ = "g2p_register_history_household_pds"
